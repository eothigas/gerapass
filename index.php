...
<body>
    ...
    <main>
        <div class="container">
            <div class="flex">
                <form id="loginForm" class="form_main" method="POST" action="<?php echo $url; ?>includes/actions/login">
                    ...
                    <div class="inputContainer">
                        ...
                        <input name="email" placeholder="Usuário" class="inputField" type="text" required value="<?= htmlspecialchars($_SESSION['old_email'] ?? '') ?>">
                    ...
                    <div class="inputContainer">
                        ...
                        <input name="password" placeholder="Senha" class="inputField" type="password" required>
                    </div>
                    <?php
